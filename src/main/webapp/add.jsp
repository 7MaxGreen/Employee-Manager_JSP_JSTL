...
<div class="container mt-2">
    <div class="form-container">
        <form action="add" method="post" style="width:70%; color: white; font-weight: bold;">
            ...
            <fieldset class="form-group" style="color: white">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="NOT_DEFINED" id="notDefined" value="NOT_DEFINED" >
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="idnp" id="idnp" placeholder="Idnp">
                </div>
            </div>
            <div class="form-group row">
                <label for="salary" class="col-sm-2 col-form-label">Salary</label>
                <div class="col-sm-10">
                    <input type="text" name="salary" class="form-control" name="salary" id="salary" placeholder="Salary">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" name="dismissDate" id="dismissDate" placeholder="Dismiss date">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="apartmentNumber" id="apartmentNumber" placeholder="Apartment number">
                </div>
            </div>
            <div class="form-group row">
